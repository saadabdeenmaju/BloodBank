    ...
    constructor(props) {
      ...
      static navigationOptions = {
        drawerIcon  : ({tintColor})=>(
          <Icon name = "help" style = {{fontSize : 24 , color:tintColor}}></Icon>
        )
      }
    render () {
        return (
            ...
            <ImageBackground source={require('../images/allbg1.png')} style = {styles.mainbg}>
                <Content>
                <Header>
              <Title style ={styles.title}>Request a Blood Group</Title>
              </Header>
                    <Left>
                    ...
                    <Card style = {styles.donorform}>
                      ...
                      <Button full dark onPress = {() =>   this.props.navigation .navigate ('Blood_Requests')}>
